...
# Moves the files "/var/backup/home.tar" to "/var/backup/home.MMDDYYYY.tar".
...
# List all files in "/var/backup", including file sizes, and save the ouput to "/var/backup/file_report.txt"
